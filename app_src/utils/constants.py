...
ICON_COLOR_LIGHT = [0.3, 0.3, 0.3, 1]
ICON_COLOR_DARK = [0.8, 0.8, 0.8, 1]

BUTTON_BG_LIGHT = [0.9, 0.9, 0.9, 1]
BUTTON_BG_DARK = [.2, .2, .2, 1]
f=1
CARD_BG_LIGHT = [f,f,1, 1]
CARD_BG_DARK = [0.15, 0.15, 0.15, 1]
