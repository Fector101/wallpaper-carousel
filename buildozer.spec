...
requirements = python3,kivy==master,kivymd,python-osc,materialyoucolor==3.0.3,asynckivy,asyncgui,pyjnius==1.7.0, docutils,netifaces,filetype,requests_toolbelt,websockets,android-widgets, android-notify
