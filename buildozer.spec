...
requirements = python3,kivy,kivymd,python-osc,https://github.com/kivy/plyer/archive/master.zip,materialyoucolor==3.0.3,asynckivy,asyncgui,pyjnius==1.7.0, docutils,netifaces,filetype,requests_toolbelt,websockets,android-widgets, https://github.com/Fector101/android_notify/archive/main.zip
...
android.permissions = RECEIVE_BOOT_COMPLETED, INTERNET, VIBRATE, USE_EXACT_ALARM, SCHEDULE_EXACT_ALARM, FOREGROUND_SERVICE, FOREGROUND_SERVICE_SPECIAL_USE, POST_NOTIFICATIONS, SET_WALLPAPER, READ_MEDIA_IMAGES, READ_MEDIA_VISUAL_USER_SELECTED, (name=android.permission.READ_EXTERNAL_STORAGE;maxSdkVersion=32), (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=28), REQUEST_INSTALL_PACKAGES, ACCESS_NETWORK_STATE, ACCESS_WIFI_STATE
